...
public class BaseCategoryTrademarkServiceImpl extends ServiceImpl<BaseCategoryTrademarkMapper,BaseCategoryTrademark> implements BaseCategoryTrademarkService {
    ...
    public List<BaseTrademark> findTrademarkList(Long category3Id) {
        ...
        //根据三级分类查询中间表 BaseCategoryTrademark
        ...
        //得到对应的品牌id
        List<Long> trademarkIds = baseCategoryTrademarkList.stream().map(item -> item.getTrademarkId()).collect(Collectors.toList());
...
//        List<BaseTrademark> baseTrademarkList = baseTrademarkMapper.selectList(queryWrapper2);

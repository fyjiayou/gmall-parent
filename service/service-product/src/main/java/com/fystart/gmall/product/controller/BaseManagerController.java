...
public class BaseManagerController {
    ...
    @ApiOperation(httpMethod = "GET", value = "获取一级分类")
    ...
    @ApiOperation(httpMethod = "GET", value = "根据一级分类id查询二级分类")
    ...
    @ApiOperation(httpMethod = "GET", value = "根据二级分类Id查询三级分类")
    ...
    @ApiOperation(httpMethod = "GET", value = "根据分类Id查询平台属性集合")
    ...
    @ApiOperation(httpMethod = "POST", value = "平台属性的新增和修改")
    ...
    @ApiOperation(httpMethod = "GET", value = "根据属性id查询属性值集合")
